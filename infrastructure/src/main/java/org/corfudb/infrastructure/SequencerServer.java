...
public class SequencerServer extends AbstractServer {
    ...
    @Getter
    @Setter
    private volatile long bootstrapEpoch = -1;
    ...
    */
    ...
    public synchronized void resetServer(CorfuPayloadMsg<SequencerTailsRecoveryMsg> msg,
        ...
        // Boolean flag to denote whether this bootstrap message is just updating and existing
        ...
        if (bootstrapEpoch == -1 && bootstrapWithoutTailsUpdate) {
